...
include::example$Fruit.java[tag=intro,indent=0,tabsize=2]
----
...
[source,java]
----
include::example$Fruit.java[tag=builder,indent=0,tabsize=2]
----
...
include::example$FruitResource.java[tag=skeleton,indent=0,tabsize=2]
----
...
.FruitResource#get
----
include::example$FruitResource.java[tag=reading,indent=0,tabsize=2]
----
...
----
include::example$FruitResource.java[tag=create,indent=0,tabsize=2]
----
...
----
include::example$FruitResource.java[tag=getSingle,indent=0,tabsize=2]
----
...
----
include::example$FruitResource.java[tag=delete,indent=0,tabsize=2]
----
...
----
include::example$ReactiveFruitResource.java[tag=get,indent=0,tabsize=2]
----
...
----
include::example$ReactiveFruitResource.java[tag=create,indent=0,tabsize=2]
----
